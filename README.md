...
|
 Shooter #1 - Zero time.zip 
|
 GSR (shooter hands) 
|
 3,462 
|
 Per-particle class labels from MLLSQ_maxParticle.csv 
|

|
 Shooter #2 - Zero time.zip 
|
 GSR (shooter hands) 
|
 3,429 
...
|
 Sparklers post handling post burn.zip 
|
 Fireworks confounder 
|
 — 
|
 HDZ class definitions only (no per-particle CSV) 
|

|
 Spinners - Post-ignition.zip 
|
 Fireworks confounder 
|
 — 
|
 HDZ class definitions only 
|

|
 Roman Candles - Post-handling, pre-ignition.zip 
|
 Fireworks confounder 
|
 — 
...
|
 Ford Explorer Rear Driver.zip 
|
 Brake dust confounder 
|
 — 
|
 HDZ class definitions only 
...
|
 GSR 
|
 NIST: Classic GSR (GSR.0, GSR.1, GSR.2) 
|
...
|
 Non-GSR 
|
 NIST: Brass — environmental, not GSR 
|

|
 ZnTi, Hg, TiZnGd, GaCuSn 
|
 Non-GSR 
|
...
|
 Ambiguous 
|
 Single-element — could be GSR fragment or environmental 
|
